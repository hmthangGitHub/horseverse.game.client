...
public interface ISocketClient : IDisposable
{
    ...
    UniTask<TResponse> Send<TRequest, TResponse>(TRequest request, float timeOut = 3.0f,CancellationToken token = default(CancellationToken)) where TRequest : IMessage
