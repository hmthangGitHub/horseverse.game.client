namespace GleyPushNotifications
{
    ...
    public class SettingsWindow : EditorWindow
    {
        ...
        {
            string path = "Assets/Plugins/GleyPlugins/Notifications/Scripts/Version.txt";
        ...
        private void CreateNotificationSettings()
        {
            ...
            if (!AssetDatabase.IsValidFolder("Assets/Plugins/GleyPlugins/Notifications/Resources"))
            {
                AssetDatabase.CreateFolder("Assets/Plugins/GleyPlugins/Notifications", "Resources");
                AssetDatabase.Refresh();
            }

            AssetDatabase.CreateAsset(asset, "Assets/Plugins/GleyPlugins/Notifications/Resources/NotificationSettingsData.asset");
