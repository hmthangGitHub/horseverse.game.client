namespace Gley.About
{
    ...
    public class GleyAboutWindow : EditorWindow
    {
        ...
        {
            Object assetToLoad = AssetDatabase.LoadAssetAtPath("Assets/Plugins/GleyPlugins/About/Editor/IconReferences.asset", typeof(IconReferences));
            if (assetToLoad == null)
            {
                assetToLoad = AssetDatabase.LoadAssetAtPath("Assets/Plugins/AboutWindow/Assets/About/Editor/IconReferences.asset", typeof(IconReferences));
            }
        ...
        AssetState GetAssetState(string folderName)
        {
            ...
            if (!AssetDatabase.IsValidFolder("Assets/Plugins/GleyPlugins/" + folderName + "/Scripts"))
            {
