    ...
    public static class AssetBundleBuilder
    {
            ...
            AssetBundleManifest manifest)
        {
            ...
            foreach (var bundle in manifest.GetAllAssetBundles())
            {
                ...
                var destFile = Path.Combine(StagingArea, fileName);
            ...
            //! Copy manifest file
            var manifestFile = Path.Combine(buildDirectory, target.ToString());
            //Debug.Log("manifestFile " + manifestFile);
            var destmaniFestFile = Path.Combine(StagingArea, target.ToString());
            //Debug.Log("manifestFile " + manifestFile);
            var mfolder = Path.GetDirectoryName(StagingArea);
